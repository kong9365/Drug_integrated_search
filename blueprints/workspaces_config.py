...
WORKSPACES = [
    {
        ...
        "event_kinds": ["new_permit", "safety", "sanction"],
        "kpi_specs": [
            ...
            {"key": "review_due", "label": "재심사 예정",   "kind": "static", "color": "info", "value": "—"},
        ],
        "actions": [
    ...
    },
    {
        ...
        "event_kinds": ["supply", "food_recall", "inspection"],
        "kpi_specs": [
            {"key": "supply",     "label": "공급중단",        "kind": "count", "color": "danger"},
            {"key": "supply_lack","label": "공급부족 위험",   "kind": "static","color": "warn", "value": "—"},
    ...
    },
    {
        ...
        "event_kinds": ["clinical", "new_permit"],
        "kpi_specs": [
            {"key": "clinical_new", "label": "신규 임상 90일", "kind": "static","color": "brand","value": "—"},
            {"key": "patent_exp",   "label": "특허 만료 12m",  "kind": "static","color": "warn", "value": "—"},
            {"key": "new_permit",   "label": "타사 신규 허가", "kind": "count", "color": "info"},
            {"key": "bioeq_pipe",   "label": "생동성 진행",   "kind": "static","color": "ok",   "value": "—"},
        ],
        "actions": [
    ...
    },
    {
        ...
        "event_kinds": ["inspection", "food_recall", "sanction"],
        "kpi_specs": [
            ...
            {"key": "haccp",      "label": "자사 HACCP",      "kind": "static","color": "ok",   "value": "유효"},
        ],
        "actions": [
