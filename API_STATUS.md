# RegHub 360 — API 작동 현황

> **마지막 업데이트**: 2026-05-26 (v2 — 신규 5개 승인 반영, 마스크 제외)
> **공통 SERVICE_KEY 발급일**: 2026-05-26 (활용기간 2년)
> **테스트 스크립트**: [smoke_test_apis.py](smoke_test_apis.py)
> **테스트 결과 JSON**: [smoke_test_result.json](smoke_test_result.json)
...
| 상태 | 건수 | 비고 |
|------|------|------|
| 🟢 작동 확인 완료 | **18 API (21 오퍼레이션)** | smoke test 21/21 통과 |
| 🟡 승인됐으나 End Point 확인 필요 | **5 API** | 동일 SERVICE_KEY 적용, 자동 탐색 실패 |
| ⚪ 프로젝트 제외 | 2 API | 마스크 관련 (사용자 결정) |
| **MVP 1차 합계** | **23 API** | (마스크 제외) |
