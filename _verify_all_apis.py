...
CASES = [
    ...
    ("의약품 허가 (주성분)", 140, "approval_ingr",
     {"item_name": "타이레놀"},
     ["ITEM_NAME", "ENTP_NAME", "MTRAL_KOR_NAME", "MTRAL_QNT", "MTRAL_UNIT"]),
    ...
    ("의약품 회수목록", 539, "recall",
     {},
     ["PRDUCT", "ENTRPS", "RTRVL_RESN", "ENFRC_YN", "ENFRC_DT"]),
    ("의약품 회수상세", 539, "recall_detail",
     {},
     ["PRDUCT", "ENTRPS", "ENTRPS_ADRES", "RTRVL_RESN", "MANUF_DATE"]),
    ("의약품외 회수", 539, "recall_etc",
     {},
     ["PRDUCT", "ENTRPS", "RTRVL_RESN", "ENFRC_YN"]),
    ("의약품 행정처분", 564, "disciplinary",
     {"entp_name": "광동제약"},
     ["ENTP_NAME", "ADDR", "VIOLATION_DETAIL", "DISPS_NAME", "DISPS_DATE"]),
    ...
    ("공급중단", 534, "supply_stop",
     {},
     ["ENTP_NAME", "ITEM_NAME", "STANDARD_CODE", "SUPPLY_STOP_DATE", "REASON"]),
    ("공급부족", 537, "supply_lack",
     {},
     ["ENTP_NAME", "ITEM_NAME", "EXPECTED_DATE", "REASON", "STOCK_QUANTITY"]),
    ...
    ("GMP 적합판정", 132, "drug_gmp_jgmt",
     {"BSSH_NM": "광동제약"},
     ["BSSH_NM", "FCTR_ADDR", "KGMP_BGMP_NAME", "GMP_INGR_MM_GROUP_NAME", "VALID_DATE"]),
    ...
    ("희귀의약품", 565, "drug_orphan",
     {},
     ["RARITY_DRUG_APPOINT_NO", "MANUFPLACE_NAME", "APPLY_NAME", "PRDUCT_NAME", "DISEASE_NAME"]),
